...
function Signup() {
  ...
  return (
    <div className="mx-auto mt-5 main-div shadow border-rounded bg-black text-white rounded-1" style={{marginBottom:-150}}>
      <h1 className="mb-2 text-center text-primary mb-4">Signup Form</h1>
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        ...
        <button className="btn btn-success d-block mb-2 mt-2 mx-auto mt-4">Signup</button>
      </form>
      <p className="lead text-center">
        Already registered?
        <Link to='/signin' className="fs-4 p-2">Signin</Link>
      </p>
    </div>
  );
}
